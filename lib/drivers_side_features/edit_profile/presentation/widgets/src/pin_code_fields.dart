...
class PinCodeTextFieldVehicle extends StatefulWidget {
  /// The [BuildContext] of the application
  final BuildContext appContext;
  ...
  @override
  _PinCodeTextFieldStateVehicle createState() => _PinCodeTextFieldStateVehicle();
}

class _PinCodeTextFieldStateVehicle extends State<PinCodeTextFieldVehicle>
    with TickerProviderStateMixin {
  TextEditingController? _textEditingController;
  FocusNode? _focusNode;
  late List<String> _inputList;
