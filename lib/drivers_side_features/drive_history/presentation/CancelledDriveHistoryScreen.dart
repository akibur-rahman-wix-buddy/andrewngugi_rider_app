...
class CancelledDriveHistoryScreen extends StatefulWidget {
  const CancelledDriveHistoryScreen({
    super.key,
  });

  @override
  State<CancelledDriveHistoryScreen> createState() => _CancelledDriveHistoryScreenState();
}

class _CancelledDriveHistoryScreenState extends State<CancelledDriveHistoryScreen> {
  @override
                      ...
                      Column(
                        children: [
                          ...
                          CustomPaint(
                            ...
                            painter: DriverDottedLinePainter(),
                          ),
                          Container(
                            padding: const EdgeInsets.all(8),
                            decoration: BoxDecoration(
...
class DriverDottedLinePainter extends CustomPainter {
  @override
