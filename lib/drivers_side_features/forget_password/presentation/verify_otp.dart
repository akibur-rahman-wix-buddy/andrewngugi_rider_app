...
class ForgetOtpVerification extends StatefulWidget {
  const ForgetOtpVerification({super.key, required this.number});
  final String number;

  @override
  State<ForgetOtpVerification> createState() => _ForgetOtpVerificationState();
}

class _ForgetOtpVerificationState extends State<ForgetOtpVerification> {
                  ...
                  children: [
                    ...
                    isLoading
                      ...
                      onPressed: () async {
                        ...
                        try {
                          bool success = await forgetOtpVerificationRx.otpCodeVerification(
                            otpCode: otpCode,
                          ...
                          if (success) {
                            ...
                            NavigationService.navigateToWithArgs(Routes.setForgetPassword,{
